...
pub fn generics<T:Add<Output = T>>(x: T, y: T) -> T {
    return  x + y;
}
...
pub fn datatypes_operators_keywords(){
...
pub fn shadowing(value: i32) -> i32{
    let x = value;
